...
export function TextInput({
  ...
  const base =
    'h-10 w-full rounded-input border bg-transparent px-md font-body font-light text-sm text-text-default placeholder:text-text-muted outline-none transition-shadow disabled:cursor-not-allowed disabled:bg-surface-disabled disabled:text-text-muted'
